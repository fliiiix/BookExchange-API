...
Book.create(:isbn => "1856694739", :title => "Book Design", :author => "Andrew Haslam", :image => "http://farm1.static.flickr.com/134/379780428_6b73b0e854.jpg", :qualitiy => :new, :status => :free, :price => 0.0, :prixFix => true, :away => false, :deleted => false, :user => u)
